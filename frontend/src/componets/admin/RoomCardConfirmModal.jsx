...
export const RoomCardConfirmModal = ({
  ...
  const handleConfirm = async (selectedRoomId) => {
    ...
    try {
      ...
      // setConfirmationMessage("Confirmación correctamente");
      setMsjOk("Confirmación correctamente");
      setSubmissionStatus('success')
      setIsConfirmationModalOpen(true);
      setUpdateRoom(true);
      // onClose();
    } catch (error) {
      // setConfirmationMessage("algo salio mal al confirmar");
      setMsjError("Posible consulta ya gestionada");
